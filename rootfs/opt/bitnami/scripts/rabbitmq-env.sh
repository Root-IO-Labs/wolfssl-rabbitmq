...
# FIX: Changed RABBITMQ_DATA_DIR to use a path under /opt/bitnami/rabbitmq/var/lib/rabbitmq
# which is mounted as writable by Bitnami Helm chart (emptyDir volume)
# This fixes Kubernetes deployment with readOnlyRootFilesystem: true
# Original: export RABBITMQ_DATA_DIR="${RABBITMQ_VOLUME_DIR}/mnesia"
export RABBITMQ_DATA_DIR="${RABBITMQ_BASE_DIR}/var/lib/rabbitmq/mnesia"
