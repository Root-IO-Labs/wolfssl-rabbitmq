...
This document defines the Operating Environment (OE) for the RabbitMQ 3.13.7 FIPS-enabled container image built on Ubuntu 22.04. The OE specification is critical for FIPS 140-3 CMVP compliance, as cryptographic module validation is tied to specific operating system versions, kernel versions, and CPU architectures.
